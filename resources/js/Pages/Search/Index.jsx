    ...
    const renderTracks = () => {
        return tracks?.map((track) => {
            return (
                ...
                <Link href={route("tracks.show", { track: track.id })} key={track.id} className="block p-6 bg-white border border-gray-200 rounded-lg shadow-md hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                    ...
                    <p className="font-normal text-gray-700 dark:text-gray-400" dangerouslySetInnerHTML={{ __html: track.description }}></p>
                </Link>
            )
        })
    }
