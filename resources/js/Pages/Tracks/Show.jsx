...
import ReviewCard from '../../Components/ReviwCard/ReviewCard';

const Show = ({ track, reviews }) => {
    console.log(track);
    ...
    return (
        <Layout>
            ...
            <div className='mt-4'>
                ...
                <h2 className="mb-4 mt-6 text-xl font-extrabold leading-none tracking-tight text-gray-900 md:text-4xl lg:text-5xl dark:text-white">Recensioni</h2>

                <div className='flex flex-col gap-4'> {renderReviews()}</div>
            </div>
        </Layout>
    )
}
